...
# Usage:
# ./create_client.sh <LOCATION> <CLIENT_NAME>
#
#
#


cp oh2/items/myflat_LOCATION_CLIENT.items myflat_$1_$2.items
cp oh2/rules/myflat_LOCATION_CLIENT.rules myflat_$1_$2.rules
...
echo "Set Client: $2"
sed -i "s/CLIENT_NAME/$2/g" myflat_$1_$2.items
sed -i "s/CLIENT_NAME/$2/g" myflat_$1_$2.rules
